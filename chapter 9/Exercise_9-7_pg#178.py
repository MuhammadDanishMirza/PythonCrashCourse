...
class Admin(User):
    def __init__(self, first_name, last_name, username, email, age, location,priviliges):
...
instance1 = Admin("John", "Doe", "johndoe", "john.doe@example.com", 25, "Cityville",["can add post", "can delete post", "can ban user"])
instance1. describe_user()
instance1.show_privileges()
